...
func ibuilder(authtoken string) string {
	...
	s.WriteString("              <td colspan=\"1\"><input type=\"submit\" value=\"Upload stub.zip\" />\n</td>")
	...
	s.WriteString("              <td colspan=\"1\"><input type=\"submit\" value=\"Download stub.zip\" /></td>\n")
	...
	s.WriteString("                  </select></td>")
	s.WriteString("               <td colspan=\"1\"><input type=\"submit\" value=\"Category History\" /></td>>\n")
	s.WriteString("               <td colspan=\"1\"><input type=\"hidden\" name=\"Authorization\" id=\"Authorization\" value=\"" + authtoken + "\" /></td>\n")

	s.WriteString("           </form>\n")
	s.WriteString("	          <td colspan=\"1\">Produce a graph using parameters</td>\n")
	s.WriteString("	     </tr>\n")
	...
	s.WriteString("          </select></td>")
	s.WriteString("          <td colspan=\"1\"><input type=\"submit\" value=\"Ad History\" /></td>\n")
	s.WriteString("          <td colspan=\"1\"><input type=\"hidden\" name=\"Authorization\" id=\"Authorization\" value=\"" + authtoken + "\" /></td>\n")
	s.WriteString("         </form>\n")
	s.WriteString("	        <td colspan=\"1\">Produce a graph using parameters</td>\n")
	s.WriteString("	     </tr>\n")
	...
	s.WriteString("          <td colspan=\"1\"><input type=\"submit\" value=\"Inventory counts\" /></td>\n")
	s.WriteString("          <td colspan=\"2\"><input type=\"hidden\" name=\"Authorization\" id=\"Authorization\" value=\"" + authtoken + "\" /></td>\n")
	s.WriteString("        </form>\n")
	s.WriteString("	        <td colspan=\"5\">Produce a graph using parameters</td>\n")
	s.WriteString("	     </tr>\n")

	s.WriteString("	     <tr>\n")
	s.WriteString("  		<form  action=\"" + config.WebAddress + "/schedcounts\" method=\"post\" target=\"_blank\">\n")
	s.WriteString(" 	      <td colspan=\"1\"><input type=\"submit\" value=\"Schedule counts\" /></td>\n")
	s.WriteString("  	      <td colspan=\"2\"><input type=\"hidden\" name=\"Authorization\" id=\"Authorization\" value=\"" + authtoken + "\" /></td>\n")
	s.WriteString("  		</form>\n")
	s.WriteString("	        <td colspan=\"5\">Produce a graph using parameters</td>\n")
	s.WriteString("	     </tr>\n")
	...
	s.WriteString("            <td colspan=\"1\"><input type=\"submit\" value=\"Clear Traffic Over 1 Year Old\" /></td>\n")
	s.WriteString("           <td colspan=\"2\"><input type=\"hidden\" name=\"Authorization\" id=\"Authorization\" value=\"" + authtoken + "\" /></td>\n")
	s.WriteString("          </form>\n")
