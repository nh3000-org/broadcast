...
func ibuilder(authtoken string) string {
	...
	s.WriteString("              <td colspan=\"1\"><input type=\"submit\" value=\"Upload stub.zip\" style=\"color: #06660377;\"/>\n</td>")
	...
	s.WriteString("                  </select></td>")
	s.WriteString("               <td colspan=\"1\"><input type=\"submit\" value=\"Category History\" style=\"color: #06660377;\" /></td>\n")
	s.WriteString("               <td colspan=\"1\"><input type=\"hidden\" name=\"Authorization\" id=\"Authorization\" value=\"" + authtoken + "\" /></td>\n")
	s.WriteString("           </form>\n")
	...
	s.WriteString("          </select></td>")
	s.WriteString("          <td colspan=\"1\"><input type=\"submit\" value=\"Ad History\" style=\"color: #06660377;\" /></td>\n")
	s.WriteString("          <td colspan=\"1\"><input type=\"hidden\" name=\"Authorization\" id=\"Authorization\" value=\"" + authtoken + "\" /></td>\n")
	s.WriteString("         </form>\n")
	s.WriteString("	        <td colspan=\"1\">Produce a line chart using parameters</td>\n")
	s.WriteString("	     </tr>\n")
	...
	s.WriteString("          <td colspan=\"1\"><input type=\"submit\" value=\"Inventory counts\" style=\"color: #06660377;\" /></td>\n")
	...
	s.WriteString(" 	      <td colspan=\"1\"><input type=\"submit\" value=\"Schedule counts\" style=\"color: #06660377;\" /></td>\n")
	s.WriteString("  	      <td colspan=\"2\"><input type=\"hidden\" name=\"Authorization\" id=\"Authorization\" value=\"" + authtoken + "\" /></td>\n")
	s.WriteString("  		</form>\n")
	s.WriteString("	        <td colspan=\"5\">Produce a pie chart using parameters</td>\n")
	s.WriteString("	     </tr>\n")
	...
	s.WriteString("            <td colspan=\"1\"><input type=\"submit\" value=\"Clear Traffic Over 1 Year Old\" style=\"color: #06660377;\" /></td>\n")
	s.WriteString("           <td colspan=\"2\"><input type=\"hidden\" name=\"Authorization\" id=\"Authorization\" value=\"" + authtoken + "\" /></td>\n")
	s.WriteString("          </form>\n")
